...
# Analíticos visuales para explotación del conocimiento en odontología

<div style="margin: 0.5rem 0 2.5rem; padding: 1.5rem; border-bottom: 1px solid #eee; text-align: center; line-height: 1.8;">
  <div style="font-size: 1.25rem; color: #333; font-weight: 600; margin-bottom: 0.4rem;">Lic. Eduardo Miguel Kiszkurno</div>
  <div style="font-size: 1.05rem; color: #555; margin-bottom: 0.4rem;">Directores: Dr. Claudio Delrieux · Dra. Debora Pollicelli</div>
  <div style="font-size: 0.95rem; color: #888; margin-top: 0.2rem;">Maestría en Explotación de Datos y Descubrimiento del Conocimiento — UBA FCEN</div>
</div>
